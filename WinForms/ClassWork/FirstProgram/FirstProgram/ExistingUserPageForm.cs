...
namespace FirstProgram
{
    public partial class ExistingUserPageForm : Form
    {
        ...
        public ExistingUserPageForm(Form1 parent_, XmlDocument xmlDocument_, XmlNode relativeTeacher_) : this()
        {
            ...
            this.Text = "Здравствуй, " + relativeTeacher.SelectSingleNode("name").InnerText + "!";
        ...
        {
            var answer = MessageBox.Show("Вы серьезно хотите выйти?", "Выход", MessageBoxButtons.YesNo);
        ...
        {
            new WatchGivenLessonsForm(xmlDocument, relativeTeacher).Show();
        }

        private void buttonStartNewLesson_Click(object sender, EventArgs e)
        {
            new NewLessonsForm().Show();
        }
